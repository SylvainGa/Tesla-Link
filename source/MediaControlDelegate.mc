...
class MediaControlDelegate extends Ui.BehaviorDelegate {
    ...
    function onSelect() {
        ...
        if (_view._showVolume) {
            ...
            _controller._tesla.mediaVolumeUp(_controller._vehicle_vin, 40, !_controller._quickReturn, method(:onCommandReturn));
        }
        else {
            ...
            _controller._tesla.mediaNextTrack(_controller._vehicle_vin, 40, !_controller._quickReturn, method(:onCommandReturn));
        }
        return true;
    }
    ...
    function onNextPage() {
        ...
        _controller._tesla.mediaTogglePlayback(_controller._vehicle_vin, 40, !_controller._quickReturn, method(:onCommandReturn));
        return true;
    }
    ...
    function onPreviousPage() {
        ...
        if (_view._showVolume) {
            ...
            _controller._tesla.mediaVolumeDown(_controller._vehicle_vin, 40, !_controller._quickReturn, method(:onCommandReturn));
        }
        else {
            ...
            _controller._tesla.mediaPrevTrack(_controller._vehicle_vin, 40, !_controller._quickReturn, method(:onCommandReturn));
        }
        return true;
    }
